...
class AccountViewTest(TestCase):
    ...
    def test_account_view_redirects_if_user_not_logged(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/accounts/account/')
...
class FavoritesListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        Favorite.objects.create(product=nocciolata, substitute=milka, profile=user)
        Favorite.objects.create(product=daim, substitute=milka, profile=user)
        Favorite.objects.create(product=nutella, substitute=daim, profile=user)
    ...
    def test_favorites_list_view_when_user_logged(self):
        ...
        self.assertEqual(str(response.context['profile'].username), 'vanrussom')
...
class FavoriteDetailViewTest(TestCase):
    ...
    def test_favorite_detail_view_redirects_if_user_not_logged(self):
        ...
        self.assertRedirects(response, f'/accounts/login/?next=/accounts/favorite/{favorite.id}/')
